...
func on_arena_difficulty_increased(arena_difficulty: int):
	...
	if arena_difficulty == 6:#30
		enemy_table.add_item(enemy_1_scene, 15)
	elif arena_difficulty == 12: #1min
		enemy_table.add_item(enemy_3_scene, 12)

	elif arena_difficulty == 18: #1min30
		enemy_table.add_item(enemy_2_scene, 8)
